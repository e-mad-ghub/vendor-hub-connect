  ...
  <Layout>
    <div className="container py-8 max-w-3xl">
      ...
      <div className="prose prose-gray max-w-none">
        <p className="text-muted-foreground mb-4">سوق الحرفيين هو نموذج لسوق إلكتروني متعدد التجار بيستعرض المزايا الأساسية لأي منصة حديثة. ده تطبيق تجريبي للعرض فقط.</p>
