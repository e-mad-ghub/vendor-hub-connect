...
const Index = () => {
  ...
  return (
    <Layout>
      <Seo
        title="سوق الحرفيين للعربيات: الرئيسية"
        description="سوق الحرفيين – مع فريقنا المختص هتقدر توصل لأي قطعة غيار بتدور عليها في مصر، جديدة أو استيراد، في ثواني من موبايلك وتوصلك لحد عربيتك."
      />
      {/* Hero Banner */}
